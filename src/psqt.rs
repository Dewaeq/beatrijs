...
mod tables {
    ...
    pub const MG_KNIGHT_TABLE: [Score; NUM_SQUARES] = [
    ...
    pub const EG_KNIGHT_TABLE: [Score; NUM_SQUARES] = [
    ...
    pub const MG_BISHOP_TABLE: [Score; NUM_SQUARES] = [
    ...
    pub const EG_BISHOP_TABLE: [Score; NUM_SQUARES] = [
    ...
    pub const MG_ROOK_TABLE: [Score; NUM_SQUARES] = [
    ...
    pub const EG_ROOK_TABLE: [Score; NUM_SQUARES] = [
    ...
    pub const MG_QUEEN_TABLE: [Score; NUM_SQUARES] = [
    ...
    pub const EG_QUEEN_TABLE: [Score; NUM_SQUARES] = [
...
pub const EG_PIECE_TABLE: [[Score; NUM_SQUARES]; NUM_PIECES] = [
    tables::EG_PAWN_TABLE,
    tables::EG_KNIGHT_TABLE,
